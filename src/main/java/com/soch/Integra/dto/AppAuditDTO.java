...
public class AppAuditDTO {
	...
	private List<AppAuditFileDTO> appAuditFileDTOs;
	...
	public List<AppAuditFileDTO> getAppAuditFileDTOs() {
		return appAuditFileDTOs;
	}
	public void setAppAuditFileDTOs(List<AppAuditFileDTO> appAuditFileDTOs) {
